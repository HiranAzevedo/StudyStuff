...
namespace SentimentModel_Consoumer
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =  @"C:\Github\StudyStuff\IA\ML.NET-Training\myMLApp\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.083372064F,L2Regularization=0.13417552F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
